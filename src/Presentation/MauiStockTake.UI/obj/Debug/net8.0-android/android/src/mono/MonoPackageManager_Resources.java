...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MauiStockTake.UI.dll" comes first in this list. */
		"MauiStockTake.UI.dll",
		"Maui.Plugins.PageResolver.Attributes.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"MauiStockTake.Client.dll",
		"MauiStockTake.Shared.dll",
